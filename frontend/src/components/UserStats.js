...
const UserStats = ({ user }) => {
    ...
    return (
        <div className="bg-sky-50 p-4 rounded-lg shadow-lg z-10 flex items-center gap-6">
            <img
            ...
            <div className="flex-1 min-w-[200px]">
                <div className="mb-2">
                    ...
                    <div className="bg-sky-100 h-2 rounded-full">
                        <div
                ...
                <div>
                    ...
                    <div className="bg-sky-100 h-2 rounded-full">
                        <div
                            className="bg-sky-700 h-2 rounded-full transition-all duration-500"
